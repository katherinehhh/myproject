    ...
    $newsTable.on('click', '.btn-primary', function(e) {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                var utime = data[0].newsdate.split('')[0];
                $('#unewsdate').val(utime);
            }
        });
    });
